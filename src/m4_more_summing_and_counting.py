...
def run_test_factorial():
    ...
    # Test 4:
    answer_from_oracle = math.factorial(29)
    answer_from_my_code = factorial(29)
...
def run_test_count_cosines_from():
    ...
    # Test 5:
    expected = 0
    answer = count_cosines_from(33, 9, 0.29)
    print('Test 5 expected:', expected)
    print('       actual:  ', answer)

    # Test 6:
    expected = 0
    answer = count_cosines_from(32, 9, 0.29)
...
def run_test_sum_unit_fractions_from():
    ...
    # Test 2:
    expected =35
    answer = count_cosines_from(3, 91, 0.29)
    print('Test 2 expected:', expected)
    print('       actual:  ', answer)

    # Test 3:
    expected = 30
    answer = count_cosines_from(3, 80, 0.29)
    print('Test 3 expected:', expected)
    print('       actual:  ', answer)
